...
function CategoriesCard() {
  return (
    <>
        ...
        <h1 className="font-bold text-2xl lg:text-3xl text-center text-orange-500">
          Our products
        </h1>
        <div className="mt-6 px-6 lg:px-0   flex justify-between gap-5 flex-col lg:flex-row ">
          <Link className="flex-1" to="/shop/bread">
            <div>
              ...
              <article>
                <p className="text-orange-500 text-xl font-bold pt-5">Bread</p>
                <p className="text-gray-500 hidden lg:block text-md pt-5">
          ...
          <Link className="flex-1" to="/shop/bakery">
            <div className="">
              ...
              <article>
                <p className="text-orange-500 text-xl font-bold pt-5">Bakery</p>
                <p className="text-gray-500 hidden lg:block text-md pt-5">
          ...
          <Link className="flex-1" to="/shop/cakes">
            <div className="">
              ...
              <article>
                <p className="text-orange-500 text-xl font-bold pt-5"> Cakes</p>
                <p className="text-gray-500 hidden lg:block text-md pt-5">
